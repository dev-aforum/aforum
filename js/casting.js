...
$(document).ready(function() {
  ...
  $(".casting_link").each(function(index, el) {
    ...
    $(this).click(function(event) {
      ...
      var $photoCount = $(this).attr("data-photos");
      var $id = $(this).attr("data-id");
      var $category = $(this).attr("data-category");
      var $name = $(this).attr("data-name");

      var carouselTitle = "<h2 class='carousel-title animated fadeIn' style='font-size:2em;width:100%;text-align:center;color:white;'>" + $name + "</h2>";
      ...
      $(".modal-content").prepend(carouselTitle);

      $(".modal-caro").append(
        carousel
      );

      console.log("caro is on");


      $(".modal").modal({
        ready: function(modal, trigger){
          //show the modal close button/icon
          $(".modal-close").removeClass('hide');

          // calc the height of the carousel
          ...
          // set the height of the carousel and initiale itw
          $(".modal-caro")
          ...
          var itemWidth = $(".carousel-item", modal).width();
          ...
          setTimeout(function () {
            ...
            $("img", $(modal) ).each(function(index){
              ...
              console.log("item widht is " + itemWidth);
              console.log("item left is " + ( itemWidth - $(this).width() ) / 2 );
              console.log(imgWidth);


              if ( imgWidth > 0 ) {
                $(this).css({"left" : ( itemWidth - imgWidth ) / 2 });
              }
              ...
              if ( imgHeight > imgWidth ) {
                ...
                $(this).css({ "height" : "80%" , "width" : "auto", "top":"20%"});
                ...
                console.log("photo orientation is landscape");
                  ...
                  $(this).css({"top" : ( itemHeight - imgHeight )/ 2 });
              } else {
                console.log("the image is oriented as landscape and the screen is smaller than 992");
              }
