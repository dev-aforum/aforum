		...
		<?php
			...
			?>
				<div class="col s6 m4 l3 xl4">
					<a class="animated casting_link bw" href="#modal" data-photos="<?php echo $modelo[1]?>" data-id="<?php echo $counter?>" data-name="<?php echo $modelo[0]?>" data-category="kids" data-measure="<?php echo $modelo[2]?>">
						<img src="img/kids/<?php echo $counter?>.jpg" class="responsive-img" alt="">
					</a>
				</div>
		<?php
			$counter++;
