...
$(document).ready(function() {
  ...
  $(".casting_link").each(function(index, el) { // para cada link
    ...
    $(this).click(function(event) { // quando os links são clickados
      ...
      // nome do modelo
      name =  "<h2 class='carousel-title animated  fadeInDown' style='animation-delay:0.65s'>" + $(this).attr("data-name")  + "</h2>";//nome do modelo

      //medidas do modelo
      measure = "<div class='measure'><h4>Medidas</h4><p class='animated fadeInUp style='animation-delay:0.75s'>" + $(this).attr("data-measure") + "</p></div>";
